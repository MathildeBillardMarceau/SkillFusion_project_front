  ...
  return (
    <div className="max-w-300 max-h-500 ">
      <main className="py-25 px-5 bg-background-charte sm:items-start">
        <div className="min-h-100 h-105 w-100 flex flex-col border-3 rounded-md border-primary-red justify-between">
          ...
          <div className="flex flex-row m-0.5">
            ...
            <button className=" self-end w-15 m-5 sticky right-0 bottom-0 px-2 border-2 rounded-md border-secondary-red bg-secondary-red text-background-charte">Voir</button>
          </div>
        </div>
      </main>
    </div>
