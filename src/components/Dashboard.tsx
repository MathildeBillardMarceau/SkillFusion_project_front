    ...
    <div className="flex items-center justify-center font-sans dark:bg-black">
      <main className="items-center justify-between  bg-[#F4ECE2] dark:bg-black  px-2">
        <div className="flex flex-col md:flex-row items-baseline border-4 rounded-md border-primary-red shadow-xl/30 px-2">
            ...
            <div className="h-full md:h-1/2 flex flex-col h-25 mx-2 mb-1">
                <div className="flex items-center justify-between">
                    <h1 className="font-bold text-2xl m-4 text-primary-text px-4">Mes cours créés</h1>
                    <Link href="/dashboard/create">
                    <button onClick={onCreateClick} type="button" className="font-bold text-2xl m-4 border-2 rounded-md md:h-25 md:max-w-55 bg-secondary-red text-background-charte px-4 cursor-pointer"> Créer un cours</button>
                    </Link>
                </div>
